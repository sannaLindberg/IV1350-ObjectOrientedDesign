...
public class View {
     ...
     * @throws IOException if the observerar cannot initialize.
     */
    ...
    public void sampleExecution() {
        ...
        scannNewItem(new ItemID("invalidID"));
        scannNewItem(new ItemID("abc123"));
        // scannNewItem(new ItemID("crachDB")); //Used to initiate database crach
        endSale();
        

    }

    private void printRunningTotals() { 
    System.out.println("Total cost (incl. VAT): " + contr.getCurRunningTotal());
    System.out.println("Total VAT: " + contr.getCurRunningVat() + "\n");
    }
